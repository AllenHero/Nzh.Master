...
function configure(PDFJS) {
    PDFJS.imageResourcesPath = '/Content/js/pdfjs-1.9.426-dist/web/images/';
    PDFJS.workerSrc = '/Content/js/pdfjs-1.9.426-dist/build/pdf.worker.js';
    PDFJS.cMapUrl = '/Content/js/pdfjs-1.9.426-dist/web/cmaps/';
...
//var DEFAULT_URL = '/upload/test.pdf';
;
