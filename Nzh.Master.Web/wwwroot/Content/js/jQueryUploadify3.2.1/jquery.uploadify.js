...
(function ($) {
        ...
        init: function (options, swfUploadOptions) {
            ...
            return this.each(function () {
                ...
                var settings = $.extend({
                    ...
                    uploader: '/api/Business/Made/PostFile',  // The path to the server-side upload script

                    // Options
                    auto: false,               // Automatically upload files when added to the queue
                    buttonClass: '',                 // A class name to add to the browse button DOM object
                    buttonCursor: 'hand',             // The cursor to use with the browse button
                    buttonImage: 'upload.png',               // (String or null) The path to an image to use for the Flash browse button if not using CSS to style the button
                    ...
                    queueID: 'queue',              // The ID of the DOM object to use as a file queue (without the #)
                    ...
                    width: 88,                // The width of the browse button
    ...
    var handlers = {
        ...
        onDialogOpen: function () {
            ...
            this.queueData.errorMsg = '某些文件未能添加到上传队列：';
        ...
        onSelect: function (file) {
            ...
            for (var n in this.queueData.files) {
                ...
                if (queuedFile.uploaded != true && queuedFile.name == file.name) {
                    var replaceQueueItem = confirm('文件 "' + file.name + '" 已经在队列中存在.\n您想替换吗？');
                    if (!replaceQueueItem) {
