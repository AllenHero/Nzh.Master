(function ($, window, document, undefined) {
    ...
    //change事件
    ComboTree.prototype.change = function (value) {
    ...
    ComboTree.prototype.initevent = function () {
        ...
        $(this.element).unbind().click(function (event) {
    ...
    ComboTree.prototype.createitem = function (SampleJSONData, container) {
        for (let j = 0; j < SampleJSONData.length; j++) {
            ...
            // li容器
            let item = $('<li data-name="' + oliName + '" data-id="' + oliId + '" data-code="' + oliCode +'"></li>'),
                divitem = $('<div data-name="' + oliName + '" data-id="' + oliId + '" data-code="' + oliCode +'" class="title-container"></div>');
    ...
    ComboTree.prototype.checkrow = function (target, oliId, ischeckbox) {
        ...
        oliCode = target[0] ? target[0].getAttribute("data-code"):target.context.parentElement.getAttribute("data-code");
    ...
    ComboTree.prototype.setSelect = function (item) {
        ...
        if (id.length > 0 ) {
            $(this.element).find("input[data-id=" + id + "]").attr("checked", true);
            this.checkrow(item, id, true);
        }
    };

    ComboTree.prototype.setSelectById = function (id) {
        item = $(this.element).find("[data-id="+id+"]");
        if (id.length > 0) {
            $(this.element).find("input[data-id=" + id + "]").attr("checked", true);
            this.checkrow(item, id, true);
        }
    ...
    ComboTree.prototype.clear = function (item) {
        ...
        //$(this.element).find('[checked]').removeAttr("checked");
