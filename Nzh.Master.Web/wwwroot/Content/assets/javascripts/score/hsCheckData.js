                ...
                $("#" + id + "_btn").click(function () {
                    ...
                    $('#' + id + '_hcd').find('input[type="checkbox"]').each(function (index, element) {
                        ...
                        if ($(this).prop("checked")) {
                            ...
                            var Name = $(this).nextAll("span").text();
                            var Code = $(this).val();
                            if (id == "PositiveScoreList") {
                                var UList = GetScoreUserInfo(Name)
                                if (UList.length != 0) {
                                    html += "<tr>";
                                    html += "<td>" + UList.UserName + "</td>";
                                    html += "<td>" + UList.UserCode + "</td>";
                                    html += "<td>0</td>";
                                    html += "<td>" + UList.Score + "</td>";
                                    html += "<td><div class='text-left'><a class='' data-toggle='modal' href='#modal-example'  onclick='ShowPositiveCheckItem(&quot;" + UList.UserName + "&quot;,&quot;" + UList.UserCode + "&quot;,0)'>编辑</a>";
                                    html += "<a id='searchdetail' data-toggle='modal' href='#modal-drpj' onclick='ShowDetail(&quot;" + UList.UserCode + "&quot;)' > 查看</a > ";
                                    html += "<a class='eva-del' href='#' onclick='btndelete(&quot;" + UList.UserCode + "&quot;,0)'>删除</a></div ></td > ";
                                    html += "</tr>";
                                }
                                else {
                                    html += "<tr>";
                                    ...
                                    html += "<td>0</td>";
                                    html += "<td>0</td>";
                                    html += "<td><div class='text-left'><a class='' data-toggle='modal' href='#modal-example'  onclick='ShowPositiveCheckItem(&quot;" + Name + "&quot;,&quot;" + Code + "&quot;,0)'>编辑</a>";
                                    html += "<a id='searchdetail' data-toggle='modal' href='#modal-drpj' onclick='ShowDetail(&quot;" + Code + "&quot;)' > 查看</a > ";
                                    html += "<a class='eva-del' href='#' onclick='btndelete(&quot;" + Code + "&quot;,0)'>删除</a></div ></td > ";
                                    html += "</tr>";
                                }
                                $("#" + id + "_Content").append(html);
                            }
                            else {
                                var UList = GetScoreUserInfo(Name)
                                if (UList.length != 0) {
                                    ...
                                    html += "<td>0</td>";
                                    html += "<td>" + UList.Score + "</td>";
                                    html += "<td><div class='text-left'><a class='' data-toggle='modal' href='#modal-example'  onclick='ShowNegativeCheckItem(&quot;" + UList.UserName + "&quot;,&quot;" + UList.UserCode + "&quot;,0)'>编辑</a>";
                                    html += "<a id='searchdetail' data-toggle='modal' href='#modal-drpj' onclick='ShowDetail(&quot;" + UList.UserCode + "&quot;)' > 查看</a > ";
                                    html += "<a class='eva-del' href='#' onclick='btndelete(&quot;" + UList.UserCode + "&quot;,0)'>删除</a></div ></td > ";
                                    html += "</tr>";
                                }
                                    ...
                                    html += "<td>0</td>";
                                    html += "<td>0</td>";
                                    html += "<td><div class='text-left'><a class='' data-toggle='modal' href='#modal-example'  onclick='ShowNegativeCheckItem(&quot;" + Name + "&quot;,&quot;" + Code + "&quot;,0)'>编辑</a>";
                                    html += "<a id='searchdetail' data-toggle='modal' href='#modal-drpj' onclick='ShowDetail(&quot;" + Code + "&quot;)' > 查看</a > ";
                                    html += "<a class='eva-del' href='#' onclick='btndelete(&quot;" + Code + "&quot;,0)'>删除</a></div ></td > ";
                                    html += "</tr>";
                                }
