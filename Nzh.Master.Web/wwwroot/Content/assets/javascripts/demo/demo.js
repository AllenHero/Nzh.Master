    ...
    $(document).ready(function() {
        ...
        $("#daterange2").daterangepicker({
            format: "YYYY-MM-DD"
                ...
                return $("#daterange2").parent().find("input").first().val(start.format("YYYY-MM-DD") + " 到 " + end.format("YYYY-MM-DD"));
        }).on('hide', function (event) {
            event.preventDefault();
            event.stopPropagation();
            var startTime = event.date;
            $('#daterange2').datetimepicker('setStartDate', startTime);
            $('#daterange2').val("");
        })/*.on('hide', function (event) {
            event.preventDefault();
            event.stopPropagation();
            var endTime = event.date;
            $('#daterange2').datetimepicker('setEndDate', endTime);
        })*/;
        $("#daterange").daterangepicker({
            ...
            dateLimit: false
                ...
                return $("#daterange span").html(start.format("YYYY-MM-DD") + " - " + end.format("YYYY-MM-DD"));
        }).on('hide', function (event) {
            event.preventDefault();
            event.stopPropagation();
            var startTime = event.date;
            $('#daterange').datetimepicker('setStartDate', startTime);
            $('#daterange').val("");
        })/*.on('hide', function (event) {
            event.preventDefault();
            event.stopPropagation();
            var endTime = event.date;
            $('#daterange').datetimepicker('setEndDate', endTime);
        })*/;
