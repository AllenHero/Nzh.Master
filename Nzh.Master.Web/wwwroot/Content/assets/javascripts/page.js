(function ($, window, document, undefined) {
    ...
    let page = function (element, options) {
    ...
    page.prototype.paging = function (total) {
    ...
    page.prototype.pagejump =function (value) {
        if (value === 0)
            page = $("#pagejump").val();
        else
            page = value;
        this.options.datafunction();
    }

    page.prototype.switchdownpage =function () {
        if (page > 1)
            page--;
        this.options.datafunction();
    }

    page.prototype.switchuppage=function (totalpage) {
        if (page < totalpage)
            page++;
        this.options.datafunction();
    }
    ...
    ComboTree.prototype.setSelect = function (item) {
        ...
        if (id) this.checkrow(item, item.attr("data-id"), true);
    };
