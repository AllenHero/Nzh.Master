$(function(){
			...
			//全选函数
			$('#modal-guanzhu .checkbox-all').click(function(){
			...
			//单个checkbox与全选的关系函数
			$('#modal-guanzhu .select-content').on('click','.checkboxs',function(e){
				//e.stopPropagation();
				console.log(e);
			...
			//$('#modal-guanzhu .select-content').on('click',"li",function(){
			...
			//左右移按钮点击事件
			$('#modal-guanzhu .arrow-btn').click(function(){
